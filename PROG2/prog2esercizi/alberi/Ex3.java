/*
Completate il metodo int k(T x, T z) in <T> e Branch<T> in modo che, in un albero generico con elementi di tipo T,
conti gli elementi elem tali che: (elem è diverso da x) e (elem è diverso da z).
...
class Ex3 {
    ...
    public static void msg() {
        System.out.println("Conta gli elementi diversi sia da x che da z.");
    }
