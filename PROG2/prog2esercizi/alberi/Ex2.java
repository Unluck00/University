/*
Completate il metodo int h(T x, T z) in <T> e Branch<T> in modo che, in un albero generico con elementi di tipo T,
conti gli elementi elem tali che: (elem > x) e (elem < z).
Usate a.compareTo(b) per confrontare i valori. Supponete che gli elementi dell’albero e x, z non siano null.
...
class Ex2 {
    ...
    public static void msg() {
        System.out.println("Conta gli elementi maggiori di x e minori di z.");
    }
