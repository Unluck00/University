...
public class User {
    ...
    // for only cooks, to track if they have been summoned for a task
    ...
    public User(String username) {
        ...
        // for cooks, to track if they have been summoned for a task
        if (this.roles.contains(Role.CUOCO)) {
            this.summoned = false;
        }
    }
