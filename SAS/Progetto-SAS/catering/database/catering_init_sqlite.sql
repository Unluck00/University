...
INSERT INTO Events (
    ...
    'Gala Aziendale Annuale',
    date('2025-06-15'), date('2025-06-16'),
    5,                          -- Chef: Antonio
    7,                          -- Manager: Giovanni
    'Grand Hotel Milano',
    time('11:00'), time('23:00'),
    120,                        -- participants
    0,                          -- fine: false
    'ben distribuito',
    NULL,                       -- nessuna segnalazione al chef
    1,           -- stato: approvato
    2
);

-- ========== SERVICES ==========
-- Primo servizio (pranzo): menu approvato
INSERT INTO Services (
    event_id, name,
    approved_menu_id,
    service_day, time_start, time_end,
    location, service_type,
    state, fine, cook_id
) VALUES (
    1,
    'Pranzo Buffet Aziendale',
    1,                          -- menu approvato
    1,
    time('12:00'), time('15:00'),
    'Salone Grande', 'buffet',
    1, 0,             -- fine: false
    5                           -- Cook: Antonio
);

-- Secondo servizio (cena): menu non ancora approvato
INSERT INTO Services (
    event_id, name,
    approved_menu_id,
    service_day, time_start, time_end,
    ...
    1,
    'Cena di Gala',
    0,                          -- non ancora approvato
    1,
    time('19:00'), time('23:00'),
    'Sala Esecutiva', 'gala',
    0, 0,        -- fine: false
    3                           -- Cook: Luca
);
...
-- ========== STAFFROLE ==========
-- Personale assegnato al servizio 1 (Pranzo)
INSERT INTO StaffRole (user_id, service_role, service_id) VALUES
(1, 'FINGER_FOOD', 1),  -- Marco al pranzo
(2, 'BEVERAGE',    1);  -- Giulia al pranzo

-- Personale assegnato al servizio 2 (Cena)
INSERT INTO StaffRole (user_id, service_role, service_id) VALUES
(1, 'BEVERAGE',    2),  -- Marco alla cena
(2, 'FINGER_FOOD', 2);  -- Giulia alla cena

-- ========== RECURRINGDATE ==========
-- Nota: l'evento 1 non è ricorrente, questi sono dati di test
-- per un ipotetico evento ricorrente (evento ID 2)
INSERT INTO Events (
    name, date_start, date_end,
    chef_id, manager_id,
    location, time_start, time_end,
    participants, fine,
    personnel_allocation, chef_advisory,
    state, type
) VALUES (
    'Evento Ricorrente Test',
    date('2025-07-01'), date('2025-07-31'),
    6,                          -- Chef: Chiara
    8,                          -- Manager: Francesca
    'Sede Centrale',
    time('09:00'), time('13:00'),
    30, 0, 'sufficiente', NULL,
    0, 2
);
...
INSERT INTO Services (
    ...
    2,
    'Coffe Break giorno 1',
    1,                          -- menu approvato
    1,
    time('10:00'), time('10:45'),
    'Sala conferenze', 'buffet',
    1, 0,             -- fine: false
    5                           -- Cook: Antonio
);
...
INSERT INTO RecurringDate (date_start, date_end, event_id) VALUES
(date('2025-07-01'), date('2025-07-01'), 2),  -- Prima occorrenza
(date('2025-07-08'), date('2025-07-08'), 2),  -- Seconda occorrenza
(date('2025-07-15'), date('2025-07-15'), 2),  -- Terza occorrenza
(date('2025-07-22'), date('2025-07-22'), 2);  -- Quarta occorrenza